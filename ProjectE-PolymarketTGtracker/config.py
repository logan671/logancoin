...
SENT_EVENTS_TTL_DAYS = int(
    os.environ.get("PROJECTE_SENT_EVENTS_TTL_DAYS", "7")
)
SENT_EVENTS_CLEANUP_INTERVAL_SECONDS = int(
    os.environ.get("PROJECTE_SENT_EVENTS_CLEANUP_INTERVAL_SECONDS", "3600")
)
